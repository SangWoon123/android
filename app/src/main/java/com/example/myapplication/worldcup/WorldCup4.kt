...
class WorldCup4 : AppCompatActivity() {
    lateinit var binding: ActivityWorldCup4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityWorldCup4Binding.inflate(layoutInflater)
    ...
    private fun onMenuSelected(selectMenu: Menu) {
        ...
        if (selectedMenus.size == 2) {
            navigateToWorldCupResult()
        } else {
            showTwoMenus()
        }
    }

    private fun navigateToWorldCupResult() {
        val intent = Intent(this, WorldCupResult::class.java)
